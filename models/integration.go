...
func (m *Integration) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 IntegrationAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.IntegrationAllOf1 = aO1
...
func (m Integration) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.IntegrationAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *Integration) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with IntegrationAllOf1
	if err := m.IntegrationAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
