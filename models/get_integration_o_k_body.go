...
func (m *GetIntegrationOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetIntegrationOKBody) validateIntegration(formats strfmt.Registry) error {
...
func (m *GetIntegrationOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetIntegrationOKBody) UnmarshalBinary(b []byte) error {
