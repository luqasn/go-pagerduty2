...
func (m *CreateIntegrationCreatedBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateIntegrationCreatedBody) validateIntegration(formats strfmt.Registry) error {
...
func (m *CreateIntegrationCreatedBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateIntegrationCreatedBody) UnmarshalBinary(b []byte) error {
