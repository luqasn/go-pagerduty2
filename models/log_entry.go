...
func (m *LogEntry) UnmarshalJSON(raw []byte) error {
	// AO0
	...
	// AO1
	var aO1 LogEntryAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.LogEntryAllOf1 = aO1
...
func (m LogEntry) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.LogEntryAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *LogEntry) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with LogEntryAllOf1
	if err := m.LogEntryAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
