...
type GetSchedulesOK struct {
	Payload *models.GetSchedulesOKBody
}
...
func (o *GetSchedulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GetSchedulesOKBody)
...
func (o *GetSchedulesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /schedules][%d] getSchedulesUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetSchedulesForbidden) Error() string {
	return fmt.Sprintf("[GET /schedules][%d] getSchedulesForbidden  %+v", 403, o.Payload)
}
...
func (o *GetSchedulesTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /schedules][%d] getSchedulesTooManyRequests  %+v", 429, o.Payload)
}
