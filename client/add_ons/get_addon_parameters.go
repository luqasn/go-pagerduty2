...
// WithID adds the id to the get addon params
func (o *GetAddonParams) WithID(id string) *GetAddonParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get addon params
func (o *GetAddonParams) SetID(id string) {
	o.ID = id
}
