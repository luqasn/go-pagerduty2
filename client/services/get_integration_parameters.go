...
// WithInclude adds the include to the get integration params
func (o *GetIntegrationParams) WithInclude(include []string) *GetIntegrationParams {
	o.SetInclude(include)
	return o
}

// SetInclude adds the include to the get integration params
func (o *GetIntegrationParams) SetInclude(include []string) {
	o.Include = include
}
