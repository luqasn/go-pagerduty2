...
// WithID adds the id to the get service params
func (o *GetServiceParams) WithID(id string) *GetServiceParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get service params
func (o *GetServiceParams) SetID(id string) {
	o.ID = id
}

// WithInclude adds the include to the get service params
func (o *GetServiceParams) WithInclude(include []string) *GetServiceParams {
	o.SetInclude(include)
	return o
}

// SetInclude adds the include to the get service params
func (o *GetServiceParams) SetInclude(include []string) {
	o.Include = include
}
