...
type PutUsersIDParams struct {
	...
	*/
	User *models.PutUsersIDParamsBody
...
func (o *PutUsersIDParams) WithUser(user *models.PutUsersIDParamsBody) *PutUsersIDParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the put users ID params
func (o *PutUsersIDParams) SetUser(user *models.PutUsersIDParamsBody) {
	o.User = user
}
