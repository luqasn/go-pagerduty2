...
// WithInclude adds the include to the get users ID params
func (o *GetUsersIDParams) WithInclude(include []string) *GetUsersIDParams {
	o.SetInclude(include)
	return o
}

// SetInclude adds the include to the get users ID params
func (o *GetUsersIDParams) SetInclude(include []string) {
	o.Include = include
}
