...
// WithInclude adds the include to the get user params
func (o *GetUserParams) WithInclude(include []string) *GetUserParams {
	o.SetInclude(include)
	return o
}

// SetInclude adds the include to the get user params
func (o *GetUserParams) SetInclude(include []string) {
	o.Include = include
}
