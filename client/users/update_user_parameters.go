...
type UpdateUserParams struct {
	...
	*/
	User *models.UpdateUserParamsBody
...
func (o *UpdateUserParams) WithUser(user *models.UpdateUserParamsBody) *UpdateUserParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the update user params
func (o *UpdateUserParams) SetUser(user *models.UpdateUserParamsBody) {
	o.User = user
}
