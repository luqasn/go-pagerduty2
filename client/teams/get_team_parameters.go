...
// WithID adds the id to the get team params
func (o *GetTeamParams) WithID(id string) *GetTeamParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get team params
func (o *GetTeamParams) SetID(id string) {
	o.ID = id
}
